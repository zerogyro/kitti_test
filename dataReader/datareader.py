...
check = '/home/jerry/kitti/image_02/data_object_image_2/training/image_2/000008.png 0,192,402,374,0 334,178,624,372,0 937,197,1241,374,0 597,176,720,261,0 741,168,792,208,0 884,178,956,240,0'
max_boxes = 100
...
def read_and_split():
    ...
    #     files = f.readlines()
    with open(cfg.data_path_kitti, "r") as f:
        files = f.readlines()
...
def process_true_boxes(box_data):
    ...
    y_true = [np.zeros((cfg.batch_size, grid_shape[i][0], grid_shape[i][1], 3, 5 + cfg.num_classes), dtype='float32') for i in
              range(3)]
    # check shape
